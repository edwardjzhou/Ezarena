...
local MAJOR, MINOR = "LibNameplate-1.0", 27
...
--~ 		debugPrint("IsNamePlateFrame", "--------------------------------------")
		...
		if frame:GetName() ~= wantedName then
...
do 
	...
	f:SetScript("OnEvent", function(this, event, ...)
		...
		elseif event == "UPDATE_MOUSEOVER_UNIT" then
			...
			if mouseFocus and mouseFocus:GetName() == "WorldFrame" then
				i = 0
